...
permit_waittime_prov_heatmap <- ComplexHeatmap::Heatmap(matrix = as.matrix(combined_permit_waittime_prov_percent),
                                                     ...
                                                     column_split = c('First permit wait time', 'First permit wait time',
                                                                      'First permit wait time', 'First permit wait time',
                                                                      'Second permit wait time', 'Second permit wait time',
                                                                      'Second permit wait time', 'Second permit wait time'),
...
permit_covid_prov_heatmap <- ComplexHeatmap::Heatmap(matrix = as.matrix(combined_permit_covid_prov_percent),
                                                ...
                                                cluster_rows = TRUE,
                                                show_row_dend = FALSE,
                                                column_split = c('First permit - issues\npandemic related', 'First permit - issues\npandemic related',
                                                                 'Second permit - issues\npandemic related', 'Second permit - issues\npandemic related'),
